                ...
                <section className='mt-6 max-w-3xl mx-auto bg-transparent flex flex-col justify-center'>
                    ...
                    <section className='flex flex-col'>
                        ...
                        <div>
                            ...
                            <p className='small mt-2'>Your lender will usually require you to have homeowners insurance while you settling your mortgage. This is a common practice among lenders because they understand that nobody wants to continue paying a mortgage on a home that been damaged or destroyed.</p>
                            <p className='small mt-2'>Here an interesting fact: Once you fully own your home, the choice to maintain homeowners insurance is entirely up to you. However, to ensure your home is protected against damages caused by fires, lightning strikes, and natural disasters that are common in your area, it is highly recommended to keep it. Therefore, always factor in these costs when using a Mortgage Calculator.</p>
                        </div>
                        <div>
